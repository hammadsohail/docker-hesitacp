...
* **[Changelog](https://github.com/techriffic/hestiacp-docker/blob/main/CHANGELOG.md)**
* **[Docker Hub](https://hub.docker.com/r/techriffic/hestiacp)**
* **[Github](https://github.com/techriffic/hestiacp-docker)**
...
```bash
wget https://raw.githubusercontent.com/techriffic/hestiacp-docker/main/docker-compose.yml
