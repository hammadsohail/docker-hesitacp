...
### Install Hestia
    ...
    && bash ./hst-install-debian-docker.sh --apache no --phpfpm yes --multiphp yes --vsftpd no --proftpd yes \
        ...
        --hostname server.hestiacp.localhost --email admin@example.com --password 3vm5epuM1Wzz6 --lang en \
